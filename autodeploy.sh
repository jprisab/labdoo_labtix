...
-[optional] Hostname that you want to set (if you want, you can skip this and do it after the restore)
-[optional] Wich additional content do you want to have automatically added (if you want, you can skip this and do it after the restore)
